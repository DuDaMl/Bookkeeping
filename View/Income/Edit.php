        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <div class='input-group date' id='datetimepicker1'>
                        <input type='text' class="form-control" value="<?=$income->date?>" name="date"/>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="number" min="0" step="1" class="form-control" id="exampleInputEmail1" placeholder="Сумма" name="amount" value="<?=$income->amount?>">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="dropdown">
                    <select class="selectpicker" data-live-search="true" name="category_id" data-width="100%">
                        ...
                        foreach ($categories as $category){
                            if($category->id == $income->category_id){
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Описание" name="description" value="<?=$income->description?>">
                </div>
            </div>
        </div>
